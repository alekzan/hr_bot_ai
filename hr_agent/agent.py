...
root_agent = Agent(
    ...
    instruction=(
        ...
        "2. Create professional, cartoon-style poster designs that address workplace concerns\n"
        ...
        "- Design PROFESSIONAL cartoon-style posters with clean, modern aesthetics\n"
        ...
        "- Create designs that look suitable for office display\n"
        ...
        "- Design should feel welcoming but maintain workplace professionalism\n"
        ...
        "\"I've created two professional poster designs to address the noise concerns. These feature clean cartoon illustrations with clear messaging to help maintain a respectful workspace environment.\"\n"
